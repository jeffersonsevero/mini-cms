...
@section('content')
   <!-- slider_area_start -->
   <div class="slider_area" style="background: {{$front_config['bgcolor']}} ">
    <div class="single_slider  d-flex align-items-center slider_bg_1">
        <div class="container">
            <div class="row align-items-center">
                <div class="col-xl-7 col-md-6">
                    <div class="slider_text ">
                        <h3 style="color: {{$front_config['textcolor']}} " class="wow fadeInDown" data-wow-duration="1s" data-wow-delay=".1s" > {{$front_config['title']}} </h3>
                        ...
                        <div class="video_service_btn wow fadeInLeft" data-wow-duration="1s" data-wow-delay=".1s">
                            <a href="#" class="boxed-btn3">Conhecer</a>
                        </div>
                    </div>
                </div>
